...
public class TurboGraphPPTableColumn extends JDBCTableColumn<TurboGraphPPTableBase>
        implements DBSTableColumn, DBPNamedObject2, JDBCColumnKeyType, DBPOrderedObject {
    private int radix;
    ...
    public TurboGraphPPTableColumn(TurboGraphPPTableBase table) {
        super(table, false);
    }

    public TurboGraphPPTableColumn(
            TurboGraphPPTableBase table,
            String columnName,
            String typeName,
            int valueType,
            int sourceType,
    ...
    @Property(
            viewable = true,
            editable = true,
            valueRenderer = DBPositiveNumberTransformer.class,
            order = 41)
    ...
    @Property(
            viewable = true,
            editableExpr = "object.dataSource.metaModel.tableColumnCommentEditable",
            updatableExpr = "object.dataSource.metaModel.tableColumnCommentEditable",
