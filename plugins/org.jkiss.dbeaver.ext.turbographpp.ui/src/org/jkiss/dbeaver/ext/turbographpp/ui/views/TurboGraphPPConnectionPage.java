...
public class TurboGraphPPConnectionPage extends ConnectionPageWithAuth implements IDialogPageProvider
{
    ...
    public void createControl(Composite composite)
    {
...

        {
            ...
            urlLabel.setText(TurboGraphPPUIMessages.dialog_connection_jdbc_url_);
        ...
        }
        {
            ...
            hostLabel.setText(TurboGraphPPUIMessages.dialog_connection_host_label);
            ...
            portLabel.setText(TurboGraphPPUIMessages.dialog_connection_port_label);
...

        {
            ...
            serverLabel.setText(TurboGraphPPUIMessages.dialog_connection_server_label);
...

        {
            ...
            dbLabel.setText(TurboGraphPPUIMessages.dialog_connection_database_schema_label);
        ...
        // Path
        {
            ...
            pathLabel.setText(TurboGraphPPUIMessages.dialog_connection_path_label);
